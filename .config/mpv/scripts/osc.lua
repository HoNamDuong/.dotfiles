    ...
    elseif source == "mouse_move" then
        ...
        if
            ...
            or (
                ...
                and ((math.abs(mouseX - state.last_mouseX) >= user_opts.minmousemove) or (math.abs(mouseY - state.last_mouseY) >= user_opts.minmousemove))
            )
        then
            show_osc()
        end
...
-- copy-paste-url
-- source: https://github.com/elhirchek/copy-paste-url
